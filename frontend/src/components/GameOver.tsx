      ...
      <div className="game-over-content">
        ...
        <div className="game-over-stats">
          <div className="stat-item">
            <img src={playerInfo.avatar} alt="Player" className="profile-picture" crossOrigin="anonymous" referrerPolicy="no-referrer" />
          ...
          <div className="stat-item">
            <img src={opponentInfo.avatar} alt="Opponent" className="profile-picture" crossOrigin="anonymous" referrerPolicy="no-referrer" />
            <div className="stat-details">
